...
enum abstract FlxButtonState2(Int) to Int
{
	...
	{
		return switch (cast this:FlxButtonState2)
		{
			case NORMAL: "normal";
 ...
 */
class FlxSquareButton extends FlxTypedButtonSQR<FlxText>
{
	/**
	...
	inline function initLabel(Text:String):Void
	{
		if (Text != null)
		{
			label = new FlxText(x + labelOffsets[FlxButtonState.NORMAL.toInt()].x, y + labelOffsets[FlxButtonState.NORMAL.toInt()].y, 20, Text);
 ...
 */
 ...
 @:generic
 #end
 class FlxTypedButtonSQR<T:FlxSprite> extends FlxSprite implements IFlxInput
 {
     /**
     ...
     {
         loadGraphic("assets/button2.png", true, 20, 20);
     }
